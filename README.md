...
- Semantic HTML is HTML tags that have meaning and be described

2. Name two big differences between ```display: block;``` and ```display: inline;```.

- display:block uses all the space, display:inline uses only the space needed
...
- Git is valuable to a team fo developers because everyone can merge code and collaborate locally then upload their code. Also, they can recover code if something happens locally or they simply want  go back to old code
